...
public class GildedPaxelItem extends MiningToolItem
{
    /*
    *   @author Brandcraft06
    */
    ...
    public GildedPaxelItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
    ...
    public float getMiningSpeedMultiplier(ItemStack stack, BlockState state) {
        ...
        if (state.isIn(BlockTags.WOOL)) {
            ...
            return THESE_MATERIALS.contains(material) ? this.miningSpeed + 1: super.getMiningSpeedMultiplier(stack, state) + 1;
        }
    }
